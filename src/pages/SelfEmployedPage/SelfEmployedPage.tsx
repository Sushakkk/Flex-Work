...
const SelfEmployedPage = () => {
    ...
    const activities = useAppSelector((state) => state.ыуд)
    ...
    return (
        <Container>
            ...
            {expeditions.length ? <ExpeditionsTable expeditions={expeditions}/> : <h3 className="text-center mt-5">Экспедиции не найдены</h3>}
        </Container>
    )
};
